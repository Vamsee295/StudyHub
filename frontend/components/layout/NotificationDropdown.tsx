    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-0 top-full mt-2.5 w-[360px] max-w-[calc(100vw-24px)] bg-white rounded-2xl border border-[var(--border)] shadow-xl shadow-[var(--ink)]/5 z-50 overflow-hidden font-sans"
        >
          {/* HEADER */}
